import 'package:ebook/book_data.dart';
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      BookSection(
                        heading: "Continuar a ler",
                      ),
                      BookSection(
                        heading: "Outros livros",
                      ),
                    ],
                  ),
                ),
...
class BookSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    List<Book> bookList;
    if (heading == "Continue lendo") {
      bookList = recentBooks;
    } else if (heading == "Descubra mais") {
      bookList = allBooks;
    } else if (heading == "Estante") {
      bookList = allBooks;
    }
    return Container(
      child: Column(
